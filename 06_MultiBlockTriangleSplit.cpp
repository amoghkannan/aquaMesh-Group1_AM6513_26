/*
Compiler instruction: g++ 06_MultiBlockTriangleSplit.cpp src/*.cpp -Iinclude -std=c++17 -o MultiBlockTriangleSplit && ./MultiBlockTriangleSplit
*/
#include <iostream>
